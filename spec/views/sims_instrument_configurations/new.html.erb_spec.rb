...
describe "sims_instrument_configurations/new.html.erb" do
  before(:each) do
    assign(:sims_instrument_configuration, stub_model(SimsInstrumentConfiguration,
      :submission_id => 1,
      :seq_num => 1,
  ...
  it "renders new sims_instrument_configuration form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => sims_instrument_configurations_path, :method => "post" do
