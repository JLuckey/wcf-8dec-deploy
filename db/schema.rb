...
ActiveRecord::Schema.define(:version => 20121023175948) do

  create_table "additional_files", :id => false, :force => true do |t|
  ...
  create_table "analysis_methods", :id => false, :force => true do |t|
    t.integer  "id",                      :null => false
    t.integer  "submission_id"
  ...
  create_table "calib_features", :id => false, :force => true do |t|
    t.integer  "id",                                         :null => false
    t.integer  "seq_num"
  ...
  create_table "exec_logs", :id => false, :force => true do |t|
    t.integer  "id",         :null => false
    t.datetime "created_on"
    t.integer  "user_id"
    t.string   "controller"
  ...
  create_table "exp_variables", :id => false, :force => true do |t|
    t.integer "id",                                         :null => false
  ...
  create_table "field_masters", :id => false, :force => true do |t|
    t.integer "id",                                   :null => false
    t.string  "pdox_table"
    t.string  "pdox_field"
  ...
  create_table "form_fields", :id => false, :force => true do |t|
    t.integer "id",                                            :null => false
    t.integer "forms_id",         :limit => 8,  :default => 0, :null => false
    t.integer "seqnum",           :limit => 8
    t.string  "field_label"
    t.string  "designator",       :limit => 10
    t.text    "help_text"
    t.integer "field_masters_id", :limit => 8
    t.string  "html_widget",      :limit => 45
    t.integer "widget_width",     :limit => 8
    t.integer "widget_height",    :limit => 8
  end
  ...
  create_table "major_elements", :id => false, :force => true do |t|
    t.integer "id",                               :null => false
    t.integer "submission_id"
    t.integer "seqnum"
  ...
  create_table "minor_elements", :id => false, :force => true do |t|
    t.integer "id",                               :null => false
  ...
  create_table "named_peaks", :id => false, :force => true do |t|
    t.integer  "id",                             :null => false
  ...
  create_table "paramsets", :id => false, :force => true do |t|
    t.integer  "id",                                        :null => false
  ...
  create_table "reference_authors", :id => false, :force => true do |t|
    t.integer  "id",                                    :null => false
  ...
  create_table "sims_field_masters", :force => true do |t|
    t.string   "pdox_table",            :limit => 40
    t.string   "pdox_field",            :limit => 40
    t.string   "pdox_data_type",        :limit => 4
    t.integer  "column_id"
    t.string   "wecf_table_name",       :limit => 30
    t.string   "wecf_column_name",      :limit => 30
    t.string   "wecf_data_type",        :limit => 40
    t.string   "help_text"
    t.integer  "sequence_on_wecf_page"
    t.string   "notes"
    t.string   "contrib_form_id",       :limit => 10
    t.string   "contrib_form_section",  :limit => 2
    t.integer  "contrib_form_field_no"
    t.string   "contrib_form_subfield", :limit => 2
    t.string   "contrib_form_prompt"
    t.decimal  "field_id",                            :precision => 10, :scale => 0
    t.integer  "data_dict_sect"
    t.integer  "data_dict_field"
    t.integer  "data_dict_subfield"
    t.string   "data_dict_comment"
    t.string   "completeness_code",     :limit => 1
    t.string   "html_widget",           :limit => 40
    t.integer  "html_height"
    t.integer  "html_width"
    t.string   "html_color",            :limit => 30
    t.string   "show_field",            :limit => 10
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "sims_instrument_configurations", :force => true do |t|
    t.integer  "submission_id"
    t.integer  "seq_num"
  ...
  create_table "sims_ion_sources", :force => true do |t|
    t.integer  "submission_id"
    t.integer  "seq_simsions"
    t.string   "purpose",                      :limit => 30
    t.text     "other_purpose_description"
    t.string   "type_of_source",               :limit => 30
    t.text     "other_source_type_descript"
    t.text     "ion_source_manufacturer"
    t.text     "ion_source_model_and_type"
    t.text     "non-_standard_ion_source"
    t.string   "beam_mass_filter_y_n",         :limit => 1
    t.text     "beam_mass_filter_description"
    t.string   "beam_species_and_charge",      :limit => 20
    t.string   "beam_gating_used_y_n",         :limit => 3
    t.text     "beam_gating_description"
    t.text     "beam_comments"
    t.decimal  "beam_voltage_v",                             :precision => 10, :scale => 0
    t.decimal  "net_beam_voltage_v",                         :precision => 10, :scale => 0
    t.string   "ion_pulsed_y_n",               :limit => 1
    t.decimal  "ion_pulse_width_ns",                         :precision => 10, :scale => 0
    t.decimal  "ion_pulse_rate_k_hz",                        :precision => 10, :scale => 0
    t.decimal  "pulsed_beam_current_n_a",                    :precision => 10, :scale => 0
    t.decimal  "d_c_beam_current_n_a",                       :precision => 10, :scale => 0
    t.text     "current_measurement_method"
    t.string   "beam_diameter_um",             :limit => 20
    t.string   "beam_raster_width_x_um",       :limit => 20
    t.string   "beam_raster_width_y_um",       :limit => 20
    t.text     "non-_standard_raster"
    t.decimal  "beam_incident_angle_deg",                    :precision => 10, :scale => 0
    t.decimal  "effect_beam_incident_ang_deg",               :precision => 10, :scale => 0
    t.decimal  "source_to_analyzer_angle_deg",               :precision => 10, :scale => 0
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "specimens", :id => false, :force => true do |t|
    t.integer  "id",                                       :null => false
    t.integer  "submission_id"
    t.integer  "seqnum"
  ...
  create_table "spectra", :id => false, :force => true do |t|
    t.integer  "id",                                          :null => false
    ...
    t.integer  "exclude_from_proof",            :limit => 2
  ...
  create_table "spectral_feat_tbl_units", :id => false, :force => true do |t|
    t.integer "id",                               :null => false
    t.integer "submission_id",                    :null => false
  ...
  create_table "spectral_features", :id => false, :force => true do |t|
    t.integer  "id",                                         :null => false
    t.integer  "seqnum"
    t.integer  "spectrum_id"
    t.string   "element",                      :limit => 32
  ...
  create_table "submiss_instruments", :id => false, :force => true do |t|
    t.integer "id",               :null => false
  ...
  create_table "submission_references", :id => false, :force => true do |t|
    t.integer  "id",                             :null => false
    t.integer  "submission_id"
    t.integer  "seqnum"
  ...
  create_table "submissions", :id => false, :force => true do |t|
    ...
    t.integer  "revision_num",            :limit => 8
    t.datetime "delete_flag"
    t.string   "technique",               :limit => 20
  end

  create_table "sysmenus", :id => false, :force => true do |t|
    t.integer "id",                           :null => false
    t.integer "parent_id"
